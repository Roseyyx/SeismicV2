...
public:
	void Create(CBaseEntity* pEntity)
	{
		...
		static auto oCreateAnimationState = reinterpret_cast<CreateAnimationStateFn>(MEM::FindPattern("client.dll", "55 8B EC 56 8B F1 B9 ? ? ? ? C7 46")); // @xref: "ggprogressive_player_levelup"
	...
	void Update(QAngle angView)
	{
		...
		static auto oUpdateAnimationState = reinterpret_cast<UpdateAnimationStateFn>(MEM::FindPattern("client.dll", "55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3 0F 11 54 24")); // @xref: "%s_aim"
	...
	void Reset()
	{
		...
		static auto oResetAnimationState = reinterpret_cast<ResetAnimationStateFn>(MEM::FindPattern("client.dll", "56 6A 01 68 ? ? ? ? 8B F1")); // @xref: "player_spawn"
