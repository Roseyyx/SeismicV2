...
//{
//	pOriginalCVar = Interfaces::ConVar->FindVar(szCVar);
//	Spoof();
//}
//
...
//		Interfaces::ConVar->UnregisterConCommand(pDummyCVar);
//		free(pDummyCVar);
//		pDummyCVar = nullptr;
//	}
//}
...
//		sprintf_s(szDummyName, 128U, "Seismic_%s", szOriginalName);
//
...
//		Interfaces::ConVar->RegisterConCommand(pDummyCVar);
//
//		CWrappedProtect protection = CWrappedProtect{ (LPVOID)pOriginalCVar->szName, 128UL, PAGE_READWRITE };
//		// rename the convar
